                ...
                {!otpSent ? (
                    <div className="space-y-3">
                        <input
                            ...
                            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 outline-none focus:border-indigo-400 min-h-[48px] text-base"
                        />
                        <button
                            onClick={handleSendOtp}
                            disabled={loading || !phone.trim()}
                            className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold min-h-[48px] transition-colors disabled:opacity-50"
                        >
                    ...
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 outline-none focus:border-indigo-400 min-h-[48px] text-base text-center tracking-widest"
                        />
                        <button
                        ...
                        <button
                            ...
                            className="w-full text-sm text-indigo-600 font-semibold py-2"
                        >
                            Change phone number
                        </button>
                    </div>
